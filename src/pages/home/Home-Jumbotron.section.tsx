...
const HomeJumbotron: React.FC<IHomeJumbotron> = ({ }) => {
  return (
    <Stack className='relative bg-gradient-to-br from-light-purple to-dark-purple h-[500px] border-b-4 border-purple'>
      <Group className='absolute bottom-0 self-center gap-0'>
        <StickerBabyGear2 size={320} className='opacity-40' /> 
        <StickerBabyGear size={320} className='opacity-40 -ml-10' /> 
        <StickerBabyGear2 size={320} className='opacity-40 -ml-10' /> 
      </Group>
